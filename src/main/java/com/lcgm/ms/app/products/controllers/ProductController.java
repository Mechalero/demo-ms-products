package com.lcgm.ms.app.products.controllers;
...
import com.lcgm.ms.app.products.services.ProductService;
...
public class ProductController {
	...
	@PostMapping
	public ResponseEntity<?> create(@RequestBody Product entity, BindingResult result){
